  ...
  return (
    <section
      ...
      className={`py-20 transition-all duration-500 ${
        isDarkMode
          ? "bg-gradient-to-b from-green-900/20 to-gray-800"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            >
              ...
              based in Kathmandu, Nepal. With experience in the MERN stack,
              UI/UX design, and machine learning projects, I bring a unique
            ...
            >
              I'm adept at delivering clean and scalable solutions with a focus
              on user-centric design. My goal is to combine creativity and code
              to bridge the gap between functionality and aesthetics, creating
              digital experiences that are both beautiful and performant.
            </p>

            <div className="pt-6">
              <a
                href="/Salin Resume.pdf"
                download
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-semibold rounded-lg hover:from-green-600 hover:to-emerald-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
